    ...
    <div className="  text-white pb-4 pt-8 px-[60px]">
        ...
        <div className="bg-[#F00073] rounded-md p-4">
          ...
          <div className=" sm:pr-[50px]">
              <a className="dark:text-white font-semibold leading-3 text-3xl text-black" href="">Logo</a>
              </div>
             
                  <p className="  dark:text-white text-black">Home</p>
                  <p className="dark:text-white text-black">Menu</p>
                  <p className="dark:text-white hidden md:block text-black">About Restaurant</p>
                  <p className="dark:text-white hidden md:block text-black"> Wine & Coctailbar</p>

              

              <button className="text-white text-[15px] sm:text-[22px] sm:ml-[30px]  bg-[#B5986D] border-white border-[1.6px] px-8 py-4 rounded-2xl font-bold bookNow">Book Now</button>
