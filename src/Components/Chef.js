  ...
  return (
    <>
      <div className="md:flex py-20 px-4 sm:px-20  justify-center  gap-10">
        <div className="py-20 px-20 rounded-xl flex items-center md:w-[736px] gm:h-[790px] bg-[#B5986D]">
          <div className="mx-auto">
          <img className=" mx-auto h-[350px] gm:h-[544px]" src="./Chef.png" alt="" />
        ...
        <div className="md:w-[50%] px-4 my-20 md:my-0 ">
          <h3 className="dark:text-white text-black text-[30px]   sm:text-[60px] md:leading-[80px] font-bold">
