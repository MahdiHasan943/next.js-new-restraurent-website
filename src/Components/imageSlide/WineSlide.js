          ...
          <SwiperSlide>
                  <div className="pb-[100px] mx-10  mt-[50px]">
                      ...
                      <img className=" mx-auto sm:w-[260px]  my-auto h-[330px]" src="../leftD.png" alt="" />
                                          ...
                                          <Link href={'/WineAndCoctail/BottledBeers'} className="text-center text-[20px] mx-auto dark:text-white text-black">
                                          View menu
                                           </Link>
                                         </div>
...
<div className="pb-[100px] mr-10 mt-[50px]">
                      ...
                      <img className="mx-auto sm:w-[260px]  my-auto h-[330px]" src="../coctail.png" alt="" />
                                          ...
                                          <div className="flex justify-center">
                                          <Link href={'/WineAndCoctail/Cocktails'} className="text-center text-[20px] mx-auto dark:text-white text-black">
                                          View menu
                                           </Link>
                                         </div>
...
<div className="pb-[100px]">
                      ...
                      <img className="mx-auto sm:w-[340px] h-[430px]" src="../spirit.png" alt="" />
                                          ...
                                          <div className="flex justify-center">
                                          <Link href={'/WineAndCoctail/Spirits'} className="text-center text-[20px] mx-auto dark:text-white text-black">
                                          View menu
                                           </Link>
                                         </div>
              ...
              <div className="pb-[100px] mt-[50px] mx-10  ">
                      ...
                      <img className="mx-auto sm:w-[260px]  my-auto h-[330px]" src="../sortD.png" alt="" />
                                          ...
                                          <div className="flex justify-center">
                                          <Link href={'/WineAndCoctail/Softdrinks'} className="text-center text-[20px] mx-auto dark:text-white text-black">
                                          View menu
                                           </Link>
                                         </div>
...
<div className="pb-[100px] mt-[50px] mr-10">
                      ...
                      <img className="mx-auto sm:w-[260px]  my-auto h-[330px]" src="../rightD.png" alt="" />
                                          ...
                                          <div className="flex justify-center">
                                          <Link href={'/WineAndCoctail/DraftBeers'} className="text-center text-[20px] mx-auto dark:text-white text-black">
                                          View menu
                                           </Link>
                                         </div>
                  ...
                  <div className="pb-[100px] mx-10  mt-[50px]">
                      ...
                      <img className=" mx-auto sm:w-[260px]  my-auto h-[330px]" src="../leftD.png" alt="" />
                                          ...
                                          <div className="flex justify-center">
                                          <Link href={'/WineAndCoctail/Wines'} className="text-center text-[20px] mx-auto dark:text-white text-black">
                                          View menu
                                           </Link>
                                         </div>
