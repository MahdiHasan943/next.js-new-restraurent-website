...
<div className="">
  ...
  <div className="xl:w-[960px] mx-auto">
    <div className="">
      ...
      Served with chunky chips, peppercorn sauce and fresh leaf salad (GF) suitable for halal
      </p>
    </div>
    {/* 2 */}
    <div className="py-20">
      ...
      Served with ba potatoes, peppercorn sauce, and fresh leaf <br /> salad. Choose from peppercorn and mushroom sauce or <br /> simply garlic butter topping
      </p>
    </div>
