...
const Softdrinks = () => {
  return (
    <div className="">
      <div
        className="h-[650px] bg-no-repeat  dark:opacity-[0.8] bg-cover bg-full bg-center w-full"
      ...
      <div className=" py-20  flex items-center px-6   sm:pl-[50px] lg:pl-[100px] xl:pl-[170px]">
        <div className="">
          ...
          <div className="xl:w-[960px] mx-auto">
            ...
            <div className="py-20">
              <div className="flex justify-between px-2">
                <p className="MDPText dark:text-white text-black ">Pepsi</p>
            ...
            <div className="">
              <div className="flex justify-between px-2">
                <p className="MDPText dark:text-white text-black ">J2O</p>
                <p className="MDPText text-[#B5986D]"></p>
              </div>
              <img className="py-2 w-full" src="../MDLine.png" alt="" />
            </div>
